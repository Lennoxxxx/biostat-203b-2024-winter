...
- Q1 (15/20)
    ...
    - Q1.1 Your output is user-fruendly.
...
- Q2 (70/80)
    ...
    - Q2.1 (5/10) Explain why read_csv cannot ingest labevents.csv.gz. `-5.0`
    ...
    - Q2.5 (10/15)
      ...
      The order is different from Q2.3. Need to mention or fix this. `-5.0`
